...
private:
   ...
   {
      Mapping mapping[] = { {1.0, 2.0}, {3.0, 3.0}, {7.0, 5.0}, {8.0, 6.5} };
      double d = 2.0;
      double expected = 2.5;

      double result = linearInterpolation(mapping, 4, d);
      assertEquals(result, expected);
   }
